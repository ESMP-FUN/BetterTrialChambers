 ...
 * @property customMobProvider Id of the [com.esmpfun.bettertrialchambers.providers.TrialMobProvider] driving spawner waves in this chamber (null / "vanilla" = unchanged vanilla behavior)
 ...
 *   `/trial info`). The [name] remains the unique identifier used in commands and the database. Null/blank =
 *   fall back to [name]. Use [label] to resolve the effective name.
 * @property boundsConfirmed True once a thorough, player-present expand pass (`/trial scan add`, or the GUI
