 ...
 * (state in [SetupState]); the moment `/trial setup` is run, [SetupState.touched] flips and
 * the nudge stops permanently. Config-gated by `setup.reminder.enabled` (default true).
 *
 * Mirrors [com.esmpfun.bettertrialchambers.managers.SnapshotReminderService]'s
