 ...
 */
class VaultDropOwnerListener(private val plugin: BetterTrialChambers) : Listener {
    ...
    companion object {
        ...
        fun init(plugin: BetterTrialChambers) {
            OWNER_KEY = NamespacedKey("trialchamberpro", "vault_owner")
            DROPPED_AT_KEY = NamespacedKey("trialchamberpro", "vault_dropped_at")
        }
    }
}
