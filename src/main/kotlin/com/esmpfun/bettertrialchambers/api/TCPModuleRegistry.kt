 ...
 * the [BetterTrialChambers] plugin and is exposed as
 ...
 *   order.
 * - [shutdownAll] is called by `BetterTrialChambers.onDisable` to unload every
 ...
 * @since v1.3.3
 */
class TCPModuleRegistry(private val plugin: BetterTrialChambers) : Listener {
    ...
    /**
     * Called once by [BetterTrialChambers] at the end of its async startup
    ...
    /**
     * Called by [BetterTrialChambers.onDisable]. Unloads every remaining
