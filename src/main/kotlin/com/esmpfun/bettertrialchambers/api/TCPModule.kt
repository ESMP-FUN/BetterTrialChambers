package com.esmpfun.bettertrialchambers.api

import com.esmpfun.bettertrialchambers.BetterTrialChambers
import org.bukkit.plugin.Plugin

/**
 * Lifecycle contract for an external plugin that extends BetterTrialChambers.
 *
 ...
 * own `onEnable`. The registry calls back into [onLoad] once BetterTrialChambers
...
interface TCPModule {
    ...
    /**
     * Human-readable display name for log messages and `/trial modules`-style
     ...
     * BetterTrialChambers is fully initialized. Modules typically use this to
     ...
     *
     * @param tcp The BetterTrialChambers plugin instance. Provides access to
     *            managers, scheduler, database, etc.
     */
    fun onLoad(tcp: BetterTrialChambers)

    /**
     * Called when the module's backing plugin is disabled, OR when
     * BetterTrialChambers itself is disabled (in which case modules are
     ...
     *
     * @param tcp The BetterTrialChambers plugin instance.
     */
    fun onUnload(tcp: BetterTrialChambers)
}
