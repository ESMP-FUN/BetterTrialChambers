...
import com.esmpfun.bettertrialchambers.dungeon.StitchParams
...
class DungeonCommand(private val plugin: BetterTrialChambers) : SubcommandHandler {
    ...
    private val importer by lazy { com.esmpfun.bettertrialchambers.dungeon.StructureImporter(plugin) }
