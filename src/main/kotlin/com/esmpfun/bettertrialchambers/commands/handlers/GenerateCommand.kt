...
import com.esmpfun.bettertrialchambers.utils.WorldEditSupport
import com.esmpfun.bettertrialchambers.utils.WorldEditUtil
    ...
    override fun execute(sender: CommandSender, args: Array<out String>) {
        ...
        when (mode) {
            "value" -> {
                ...
                // Generation from saved var name: /trial generate value <varName> [chamberName]
