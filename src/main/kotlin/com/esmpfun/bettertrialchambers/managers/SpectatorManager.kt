 ...
 */
class SpectatorManager(private val plugin: BetterTrialChambers) {
    ...
    private val prevGameModeKey = org.bukkit.NamespacedKey("trialchamberpro", "spectator_prev_gamemode")
    private val prevLocationKey = org.bukkit.NamespacedKey("trialchamberpro", "spectator_prev_location")
    ...
    fun offerSpectatorMode(player: Player, chamber: Chamber, deathLocation: Location): Boolean {
        ...
        if (!player.hasPermission("btc.spectate")) {
            return false
        }
