...
import com.esmpfun.bettertrialchambers.api.events.StatisticsUpdatedEvent
 ...
 */
class StatisticsManager(private val plugin: BetterTrialChambers) {
    ...
    fun formatTime(seconds: Long): String {
        return com.esmpfun.bettertrialchambers.utils.MessageUtil.formatTimeSeconds(plugin, seconds)
    }
}
