...
import com.esmpfun.bettertrialchambers.integrations.claims.Refl
...
object AdvancedEnchantmentsHook {
    ...
    fun register(plugin: BetterTrialChambers) {
    ...
    private fun handle(plugin: BetterTrialChambers, event: Event) {
        try {
    ...
    private fun dbg(plugin: BetterTrialChambers, message: String) {
     ...
     */
    private fun affectsChamber(plugin: BetterTrialChambers, player: Player): Boolean {
    ...
    private fun notify(plugin: BetterTrialChambers, player: Player) {
